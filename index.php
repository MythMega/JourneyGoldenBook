...
<div class="content">
    <form action="traitement.php" method="POST">
        ...
        <label for="inputName" class="txtColored"><strong>Message (optional)</strong></label>
    ...
    <a href="list.php"><button class="btn btn-primary mb-3 formButton">See List</button></a>
</div>
